...
def run_flow():
    ...
    data_sources.append(ProcessingInput(
        ...
        dataset_definition=DatasetDefinition(
            ...
            athena_dataset_definition=AthenaDatasetDefinition(
                ...
                output_s3_uri="s3://sagemaker-us-east-1-106905379555/athena/Inpatient_Claim/",
    ...
    data_sources.append(ProcessingInput(
        source="s3://sagemaker-us-east-1-106905379555/DW/DE1_0_2008_Beneficiary_Summary_File_Sample_20.csv",  # You can override this to point to other dataset on S3
    ...
    iam_role = 'arn:aws:iam::106905379555:role/service-role/AmazonSageMaker-ExecutionRole-20191002T141534'  # sagemaker.get_execution_role()
